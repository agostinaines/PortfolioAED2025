...
public class TVertice<T> implements IVertice {
    ...
    public int getNumBp() { return numBp; }
    public void setNumBp(int numBp) { this.numBp = numBp; }

    public int getNumBajo() { return numBajo; }
    public void setNumBajo(int numBajo) { this.numBajo = numBajo; }
